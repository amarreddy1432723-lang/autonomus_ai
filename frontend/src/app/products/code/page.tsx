    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Your autonomous software engineering organization.
        </h1>
        <p style={{
          fontSize: '1.25rem',
          color: '#8B919E',
          ...
          Arceus Code creates a persistent AI engineering team for each repository: it builds a digital twin, plans missions, executes with evidence, reviews changes, verifies outcomes, supports rollback, and learns from every completed mission.
        </p>
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          Built for Repository Missions, Not One-Off Prompts
        </h2>
          ...
          {[
            {
              ...
              desc: 'Arceus builds a persistent engineering profile for every repository: architecture, services, dependencies, patterns, risks, decisions, and previous missions.'
            },
            {
              icon: <Terminal size={24} color="#00D084" />,
              title: 'Engineering Organization',
              desc: 'Mission leads, architects, implementers, QA, security, and reviewers work as one organization with separate responsibilities and controlled authority.'
            },
            {
              icon: <FileCode size={24} color="#9B5DE5" />,
              title: 'Evidence-Based Execution',
              desc: 'Every change is connected to a task, decision, command output, verification result, work receipt, and rollback path.'
            },
            {
              icon: <Shield size={24} color="#F5A623" />,
              title: 'Governed Authority',
              desc: 'Arceus separates planning, implementation, review, verification, and approval so routine work can move quickly without giving agents unchecked power.'
            },
            {
              icon: <Cpu size={24} color="#4F8EF7" />,
              title: 'Engineering Advisor',
              desc: 'Arceus proactively recommends high-value missions from repository health, risk signals, failed checks, missing tests, and repeated friction.'
            },
            {
              icon: <CheckCircle2 size={24} color="#00D084" />,
              title: 'Continuous Learning',
              desc: 'Completed missions produce validated lessons, reusable standards, and organization memory that make future missions more accurate.'
            }
          ].map((cap, i) => (
            <div key={i} style={{
              background: '#0F1117',
