  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', padding: 24, background: '#f7f8fa', color: '#1b1b1f' }}>
      <section style={{ width: 'min(430px, 100%)', border: '1px solid #ececec', borderRadius: 16, padding: 28, background: '#ffffff', boxShadow: '0 24px 70px rgba(17, 24, 39, 0.08)' }}>
        ...
        <h1 style={{ fontSize: 28, lineHeight: 1.15, margin: '0 0 8px' }}>Sign in to Arceus Code</h1>
        <p style={{ margin: '0 0 22px', color: '#5d6472', lineHeight: 1.55 }}>Use your Arceus account to connect the workspace, Mission Control, and desktop runtime.</p>
        ...
        <p style={{ margin: '18px 0 0', color: '#5d6472', fontSize: 13 }}>
          New to Arceus?{' '}
          <Link href={`/sign-up?redirect_url=${encodeURIComponent(redirectUrl)}`} style={{ color: '#5f34e8', fontWeight: 800, textDecoration: 'none' }}>Create an account</Link>
        </p>
      </section>
    </main>
  );
