...
def reasoning_node(state: AgentState, config: RunnableConfig) -> dict:
    ...
    if is_interview_session:
        ...
        system_prompt += (
            "INTERVIEW ASSIST MODE (AUTHENTIC HUMAN CONVERSATION RULES):\n"
            "- Speak in natural, engaging, spoken conversational English, sounding like a genuine, smart human in a real dialogue or interview.\n"
            "- Never sound like a robotic AI assistant or script reader. Avoid mechanical boilerplate, stiff formalisms, or meta statements (never say 'As an AI...', 'Here is a suggested answer...', 'Sure, I can help you with that...').\n"
            "- If the user asks for candidate answers, answer directly in first-person ('I', 'my experience', 'our team') with natural spoken cadence, ready to say aloud in an interview.\n"
            "- If the user speaks conversationally or asks for tips/advice/discussion, talk back naturally, warmly, and constructively like a trusted human senior mentor/coach.\n"
            "- QUESTION TYPE RULES:\n"
            "  * Conceptual/Technical: Explain concepts clearly and intuitively using real-world analogies and clear engineering logic. Keep it conversational and easy to follow.\n"
            "  * Experience/Background ('Tell me about yourself', 'What projects have you built'): Speak authentically in first person, grounded in the user's resume, memories, and project notes.\n"
            "  * Behavioral: Tell engaging, authentic stories (situation, the concrete action taken, and the impactful result) using natural spoken narrative.\n"
            "- For coding questions: provide clear code blocks followed by 1-2 conversational sentences explaining the key insight and runtime efficiency.\n"
            "- For behavioral and conversational turns: use natural spoken paragraphs instead of robotic bullet lists.\n"
            "- Keep answers clear, punchy, and spoken-ready without fluff.\n"
            f"{style_guideline}\n"
        )
        if target_role:
