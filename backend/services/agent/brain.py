...
def reasoning_node(state: AgentState, config: RunnableConfig) -> dict:
    ...
    if is_interview_session:
        ...
        system_prompt += (
            ...
            "- Do NOT say 'As an AI...', 'Here is the answer...', 'I would say...', or any introductory or meta remarks.\n"
            "- NEVER say 'there has been a misunderstanding', 'the question seems to be', or any meta-commentary. Extract the best-guess question and answer it.\n"
            "- QUESTION TYPE RULES (follow strictly):\n"
            "  * If the question is a pure concept, theory, or coding question (e.g., 'what is X', 'explain X', 'difference between X and Y', 'write a function to...'): "
            "answer ONLY with knowledge. Do NOT mention the resume, projects, personal experience, or 'In my project...'. "
            "Give a clean, direct, knowledgeable answer as an expert would.\n"
            "  * If the question explicitly asks about the candidate's experience, projects, background, or strengths (e.g., 'tell me about yourself', 'describe a project', 'what have you worked on'): "
            "USE the uploaded resume, memories, and project notes as the PRIMARY source. Ground every claim in the resume.\n"
            "  * For behavioral questions (tell me about a time..., describe a situation...): use compact STAR format in natural spoken language.\n"
            "- For TECHNICAL or CODING concept questions: produce a proper markdown code block (```language\\n...\\n```) when code is relevant. "
            "Never inline code in prose. Format: one spoken intro sentence → code block → 2-3 sentences on logic/complexity.\n"
            "- For HR, behavioral, and experience questions: use natural spoken paragraphs. No long bullet lists or markdown headers.\n"
            "- Do not invent metrics, companies, technologies, or project facts not in the resume.\n"
