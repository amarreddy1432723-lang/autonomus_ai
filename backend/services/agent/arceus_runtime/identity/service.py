...
ROLE_DEFINITIONS: tuple[RoleDefinition, ...] = (
    ...
    RoleDefinition(
        role_key="developer",
        name="Developer",
        permissions=["mission.create", "project.view", "collaboration.view", "collaboration.message", "collaboration.presence", "task.create", "task.view", "knowledge.create", "knowledge.view", "repository.read", "repository.update", "tool.execute", "test.run", "telemetry.view", "billing.enforce", "billing.meter", "marketplace.view", "extension.view", "extension.invoke", "deployment.view", "deployment.plan", "environment.view", "release.view", "security.ops.view", "data.catalog.view", "data.metric.view"],
    ...
    RoleDefinition(
        role_key="security",
        name="Security",
        permissions=["security.evaluate", "security.audit.view", "security.ops.view", "security.ops.manage", "security.finding.write", "security.response.manage", "security.exception.approve", "security.evidence.write", "secret.review", "deployment.veto", "deployment.view", "deployment.health", "deployment.drift", "telemetry.view", "alert.view", "incident.manage", "extension.view", "extension.security.review", "admin.enterprise.view", "admin.access_review.manage", "admin.audit.export", "admin.policy.manage"],
        human_only_approvals=True,
    ...
    RoleDefinition(
        role_key="qa",
        name="QA",
        permissions=["verification.manage", "test.run", "evidence.collect", "review.complete", "telemetry.view", "telemetry.write", "security.ops.view", "security.finding.write", "security.evidence.write", "data.catalog.view", "data.quality.write"],
        human_only_approvals=True,
    ...
    RoleDefinition(
        ...
        permissions=["deployment.view", "deployment.plan", "deployment.execute", "deployment.rollback", "deployment.health", "deployment.drift", "environment.view", "environment.manage", "release.view", "telemetry.view", "telemetry.dashboard.view", "telemetry.write", "alert.view", "alert.manage", "incident.manage", "security.ops.view", "security.response.manage", "security.evidence.write", "data.pipeline.view", "data.quality.write", "admin.enterprise.view"],
        human_only_approvals=True,
    ...
    RoleDefinition(
        role_key="viewer",
        name="Viewer",
        permissions=["mission.view", "project.view", "collaboration.view", "task.view", "knowledge.view", "artifact.view", "audit.view", "billing.view", "marketplace.view", "extension.view", "deployment.view", "environment.view", "release.view", "security.ops.view", "data.catalog.view", "data.metric.view", "admin.enterprise.view"],
